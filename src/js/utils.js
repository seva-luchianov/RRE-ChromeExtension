...
function createListEntryDIV(parentID, value, displayStatus, deleteCallback) {
...
function loadRecommendations(seedData, callback) {
...
module.exports = {
    ...
    createListEntryDIV: createListEntryDIV,
    xhr: {
